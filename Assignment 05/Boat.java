...
class Boat extends Vehicle {
   ...
   public String toString() {
      return String.format("%s:%n%s\t%-10s: %.2f %s%n\t%-10s: %s%n\t%-10s: %s%n", "Boat", 
            super.toString(), "MPG/GPH", this.gasMileage(), "gallons per hour", "Type", 
                                         getBoatType(), "Made of", getBoatConstruct());
   }  // end toString
